...
<div className="data">
    ...
    <span className="pin-shadow">< FiMapPin  style={{ animation: 'pin 2s linear 1'}} color="#FFB362" size={30}/></span>
      ...
      <p className="data-other"> UV index is <span>
        ...
        <p className="data-weathertype"> {weather_descriptions} {" "}
                ...
                {current && current.temperature >23 && current.weather_descriptions[0]==="Rain"  ?  <GiRaining color="rgb(105, 93, 93)" size={38}  style={{paddingLeft:'10px',marginBottom:'-5px'}}/>  : null }
        </p>  
